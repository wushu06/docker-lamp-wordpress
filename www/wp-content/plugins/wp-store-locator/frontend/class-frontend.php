        ...
        public function create_category_filter() {
            ...
            if ( count( $terms ) > 0 ) {
                ...
                if ( $filter_type == 'checkboxes' ) {
                    ...
                    $category = '<div id="wpsl-category" class="checkfire-custom">' . "\r\n";
                    $category .= '<label for="wpsl-category-list">' . esc_html( $wpsl->i18n->get_translation( 'category_label', __( 'Category', 'wpsl' ) ) ) . '</label><br>' . "\r\n";
