...
jQuery(document).ready(function () {
    ...
    jQuery('#variable_product_options').delegate('span.add_var_csp', 'click', function () {
        ...
        table_to_be_considered.append(
                ...
                '<td class="remove_var_csp" style="color:red;cursor: pointer;"><img src="' + wdm_variable_product_csp_object.minus_image + '"></td>' +
                '<td class="add_var_csp" style="cursor: pointer;"><img src="' + wdm_variable_product_csp_object.plus_image + '"></td>' +
                '</tr>'
                );
    });
...
//Remove row when remove button is clicked
    jQuery('#variable_product_options').delegate('td.remove_var_csp', 'click', function () {
        ...
        if (last_tr_element.find("th:last").length) {
            ...
            parent_table_element.before('<span class="add_var_csp" style="cursor: pointer; margin: 1em;display:block;"><button type="button" class="button">'+wdm_variable_product_csp_object.add_new_pair+'</button></span>');
        }
        else if (!last_tr_element.find("td:last").hasClass('add_var_csp')) {
            last_tr_element.append('<td class="add_var_csp" style="cursor: pointer;"><img src="' + wdm_variable_product_csp_object.plus_image + '"></td>');
        }
    });
