...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<input type="submit" class="woo-login red-button hvr-sweep-to-right text-center" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" /><br/>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<p class="woocommerce-FormRow form-row">
				...
				<input type="submit" class="red-button hvr-sweep-to-right text-center" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
			</p>
